...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("iosTest");
#else
        glview = cocos2d::GLViewImpl::createWithRect("iosTest", Rect(0,0,960,640));
#endif
...
//    sc->addRegisterCallback(register_myTestFuncJS_Helper);
